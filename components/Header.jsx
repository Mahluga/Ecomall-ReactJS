                ...
                <nav className="navbar navbar-first navbar-expand-lg">
                    <div className="container-fluid">
                        ...
                        <ul className="d-flex gap-5 mt-3 me-5">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="fa-regular fa-user"></i> <span>{lang === "AZ" ? "Mənim Hesabım" : "My Account"}</span> <br />{lang === "AZ" ? "Giriş" : "Login"}</a>
                            </li>
                            <li class="nav-item">
                                <NavLink class="nav-link" to="/cart"></NavLink>
                            </li>
                            <Link to='/cart' class="btn btn-primary position-relative">
                            ...
                            {/* <li>
                                ...
                                }} type="button" className="btn btn-primary position-relative ms-3" style={{ fontWeight: "bolder" }}>
